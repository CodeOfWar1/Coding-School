...
import { FaTimes, FaArrowLeft, FaArrowRight, FaDownload, FaShare, FaExpand, FaCompress } from 'react-icons/fa'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {lightboxOpen && (
        ...
        >
          ...
          <button
            onClick={closeLightbox}
            className="absolute top-4 right-4 text-white hover:text-[#faa853] transition-colors z-10"
          >
            <FaTimes size={32} />
          </button>
          ...
          <button
            ...
            className="absolute left-4 text-white hover:text-[#faa853] transition-colors z-10 bg-black/50 rounded-full p-3 hover:bg-black/70"
          >
            <FaArrowLeft size={24} />
          </button>
          ...
          <button
            ...
            className="absolute right-4 text-white hover:text-[#faa853] transition-colors z-10 bg-black/50 rounded-full p-3 hover:bg-black/70"
          >
