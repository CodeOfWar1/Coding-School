...
export default function RegisterPaymentPage() {
  return (
    <div className="min-h-screen" style={{ background: 'var(--app-bg-page)' }}>
      ...
      <main className="mx-auto max-w-lg px-4 py-10">
        ...
        <h1 className="mt-2 text-3xl font-black tracking-tight text-slate-900">Register student + payment</h1>
        <p className="mt-2 text-sm text-slate-600">
          Submit enrollment details and initial payment. Records are stored per your school&apos;s Supabase rules.
        </p>
        <div className="app-card mt-8 border-slate-200/80 p-6 shadow-lg">
