  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex max-h-[92vh] w-full max-w-xl flex-col overflow-hidden rounded-t-3xl border border-[var(--anvil-royal)]/20 bg-white shadow-2xl sm:max-h-[90vh] sm:rounded-3xl">
        <div className="shrink-0 bg-gradient-to-br from-[var(--anvil-royal)] via-[var(--anvil-cyan)] to-[var(--anvil-royal-deep)] px-6 pb-8 pt-6 text-white">
          <div className="flex items-start justify-between gap-3">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-white/75">Enrollment</p>
              <h2 id="payment-modal-title" className="mt-1 text-3xl font-black tracking-tight">
                Register & pay
              </h2>
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-6 py-6">
          {!user ? (
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6 text-center">
              <p className="text-base font-semibold text-slate-800">Sign in required</p>
